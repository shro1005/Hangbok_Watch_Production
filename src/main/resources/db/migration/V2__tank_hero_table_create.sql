...
(id bigint not null, win_game int, lose_game int, entire_game int, win_rate varchar(7), play_time varchar(10), kill_per_death varchar(10),
 spent_on_fire_avg varchar(10), death_avg varchar(10), block_damage_per_life varchar(10), damage_to_hero_per_life varchar(10),
 damage_to_shield_per_life varchar(10), damage_amp_avg varchar(10), gold_medal varchar(10), silver_medal varchar(10), bronze_medal varchar(10), primary key (id));
...
(id bigint not null, win_game int, lose_game int, entire_game int, win_rate varchar(7), play_time varchar(10), kill_per_death varchar(10),
 ...
 projected_barrier_avg varchar(10), gold_medal varchar(10), silver_medal varchar(10), bronze_medal varchar(10), primary key (id));
...
(id bigint not null, win_game int, lose_game int, entire_game int, win_rate varchar(7), play_time varchar(10), kill_per_death varchar(10),
 ...
 self_heal_per_life varchar(10), gold_medal varchar(10), silver_medal varchar(10), bronze_medal varchar(10), primary key (id));
