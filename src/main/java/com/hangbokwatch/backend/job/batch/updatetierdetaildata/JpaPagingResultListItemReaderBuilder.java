...
public class JpaPagingResultListItemReaderBuilder<T> {
     ...
     */
    public JpaPagingResultListItemReaderBuilder<T> saveState(boolean saveState) {
     ...
     */
    public JpaPagingResultListItemReaderBuilder<T> name(String name) {
        this.name = name;
     ...
     */
    public JpaPagingResultListItemReaderBuilder<T> maxItemCount(int maxItemCount) {
     ...
     */
    public JpaPagingResultListItemReaderBuilder<T> currentItemCount(int currentItemCount) {
     ...
     */
    public JpaPagingResultListItemReaderBuilder<T> pageSize(int pageSize) {
     ...
     */
    public JpaPagingResultListItemReaderBuilder<T> parameterValues(Map<String, Object> parameterValues) {
     ...
     */
    public JpaPagingResultListItemReaderBuilder<T> queryProvider(JpaQueryProvider queryProvider) {
     ...
     */
    public JpaPagingResultListItemReaderBuilder<T> queryString(String queryString) {
     ...
     */
    public JpaPagingResultListItemReaderBuilder<T> transacted(boolean transacted) {
     ...
     * @return this instance for method chaining
     */
    public JpaPagingResultListItemReaderBuilder<T> entityManagerFactory(EntityManagerFactory entityManagerFactory) {
     ...
     */
    public JpaPagingResultListItemReader<T> build() {
        ...
        JpaPagingResultListItemReader<T> reader = new JpaPagingResultListItemReader<>();
