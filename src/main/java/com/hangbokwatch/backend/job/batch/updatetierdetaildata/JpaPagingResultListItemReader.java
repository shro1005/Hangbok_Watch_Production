...
public class JpaPagingResultListItemReader<T> extends AbstractPagingResultListItemReader<T> {
    ...
    public JpaPagingResultListItemReader() {
        setName(ClassUtils.getShortName(JpaPagingResultListItemReader.class));
    }
