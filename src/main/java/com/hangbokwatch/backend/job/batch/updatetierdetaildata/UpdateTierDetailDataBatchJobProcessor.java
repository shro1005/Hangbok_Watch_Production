...
//    @Value("#{jobParameters[season]}") Double season;
    ...
    public CompetitiveDetailDto process(List<Player> items) throws Exception {
        ...
        PlayerDetail soldier76Detail =  new PlayerDetail((long)min, season, 0, "soldier-76", "솔저: 76",
                ...
                calculateData(datas[0][12],soldier76Cnt), calculateData(datas[0][2],soldier76Cnt), calculateData(datas[0][3],soldier76Cnt), calculateData(datas[0][4],soldier76Cnt),
        ...
        PlayerDetail reaperDetail = new PlayerDetail((long)min, season, 1, "reaper", "리퍼",
                ...
                calculateData(datas[1][12],reaperCnt), calculateData(datas[1][2],reaperCnt), calculateData(datas[1][3],reaperCnt), calculateData(datas[1][4],reaperCnt),
        ...
        PlayerDetail junkratDetail = new PlayerDetail((long)min, season, 2, "junkrat", "정크랫",
                ...
                calculateData(datas[2][12],junkratCnt), calculateData(datas[2][2],junkratCnt), calculateData(datas[2][3],junkratCnt), calculateData(datas[2][4],junkratCnt),
        ...
        PlayerDetail widowmakerDetail = new PlayerDetail((long)min, season, 3, "widowmaker", "위도우메이커",
                ...
                calculateData(datas[3][12],widowmakerCnt), calculateData(datas[3][2],widowmakerCnt), calculateData(datas[3][3],widowmakerCnt), calculateData(datas[3][4],widowmakerCnt),
        ...
        PlayerDetail torbjornDetail = new PlayerDetail((long)min, season, 4, "torbjorn", "토르비욘",
                ...
                calculateData(datas[4][12],torbjornCnt), calculateData(datas[4][2],torbjornCnt), calculateData(datas[4][3],torbjornCnt), calculateData(datas[4][4],torbjornCnt),
        ...
        PlayerDetail tracerDetail = new PlayerDetail((long)min, season, 5, "tracer", "트레이서",
                ...
                calculateData(datas[5][12],tracerCnt), calculateData(datas[5][2],tracerCnt), calculateData(datas[5][3],tracerCnt), calculateData(datas[5][4],tracerCnt),
        ...
        PlayerDetail pharahDetail = new PlayerDetail((long)min, season, 6, "pharah", "파라",
                ...
                calculateData(datas[6][12],pharahCnt), calculateData(datas[6][2],pharahCnt), calculateData(datas[6][3],pharahCnt), calculateData(datas[6][4],pharahCnt),
        ...
        PlayerDetail hanzoDetail = new PlayerDetail((long)min, season, 7, "hanzo", "한조",
                ...
                calculateData(datas[7][12],hanzoCnt), calculateData(datas[7][2],hanzoCnt), calculateData(datas[7][3],hanzoCnt), calculateData(datas[7][4],hanzoCnt),
        ...
        PlayerDetail asheDetail = new PlayerDetail((long)min, season, 8, "ashe", "애쉬",
                ...
                calculateData(datas[8][12],asheCnt), calculateData(datas[8][2],asheCnt), calculateData(datas[8][3],asheCnt), calculateData(datas[8][4],asheCnt),
        ...
        PlayerDetail symmetraDetail = new PlayerDetail((long)min, season, 9, "symmetra", "시메트라",
                ...
                calculateData(datas[9][12],symmetraCnt), calculateData(datas[9][2],symmetraCnt), calculateData(datas[9][3],symmetraCnt), calculateData(datas[9][4],symmetraCnt),
        ...
        PlayerDetail sombraDetail = new PlayerDetail((long)min, season, 10, "sombra", "솜브라",
                ...
                calculateData(datas[10][12],sombraCnt), calculateData(datas[10][2],sombraCnt), calculateData(datas[10][3],sombraCnt), calculateData(datas[10][4],sombraCnt),
        ...
        PlayerDetail bastionDetail = new PlayerDetail((long)min, season, 11, "bastion", "바스티온",
                ...
                calculateData(datas[11][12],bastionCnt), calculateData(datas[11][2],bastionCnt), calculateData(datas[11][3],bastionCnt), calculateData(datas[11][4],bastionCnt),
        ...
        PlayerDetail meiDetail = new PlayerDetail((long)min, season, 12, "mei", "메이",
                ...
                calculateData(datas[12][12],meiCnt), calculateData(datas[12][2],meiCnt), calculateData(datas[12][3],meiCnt), calculateData(datas[12][4],meiCnt),
        ...
        PlayerDetail mccreeDetail = new PlayerDetail((long)min, season, 13, "mccree", "맥크리",
                ...
                calculateData(datas[13][12],mccreeCnt), calculateData(datas[13][2],mccreeCnt), calculateData(datas[13][3],mccreeCnt), calculateData(datas[13][4],mccreeCnt),
        ...
        PlayerDetail doomfistDetail = new PlayerDetail((long)min, season, 14, "doomfist", "둠피스트",
                ...
                calculateData(datas[14][12],doomfistCnt), calculateData(datas[14][2],doomfistCnt), calculateData(datas[14][3],doomfistCnt), calculateData(datas[14][4],doomfistCnt),
        ...
        PlayerDetail genjiDetail = new PlayerDetail((long)min, season, 15, "genji", "겐지",
                ...
                calculateData(datas[15][12],genjiCnt), calculateData(datas[15][2],genjiCnt), calculateData(datas[15][3],genjiCnt), calculateData(datas[15][4],genjiCnt),
        ...
        PlayerDetail orisaDetail = new PlayerDetail((long)min, season, 16, "orisa", "오리사",
                ...
                calculateData(datas[16][12],orisaCnt), calculateData(datas[16][2],orisaCnt), calculateData(datas[16][3],orisaCnt), calculateData(datas[16][4],orisaCnt),
        ...
        PlayerDetail sigmaDetail = new PlayerDetail((long)min, season, 17, "sigma", "시그마",
                ...
                calculateData(datas[17][12],sigmaCnt), calculateData(datas[17][2],sigmaCnt), calculateData(datas[17][3],sigmaCnt), calculateData(datas[17][4],sigmaCnt),
        ...
        PlayerDetail zaryaDetail = new PlayerDetail((long)min, season, 18, "zarya", "자리야",
                ...
                calculateData(datas[18][12],zaryaCnt), calculateData(datas[18][2],zaryaCnt), calculateData(datas[18][3],zaryaCnt), calculateData(datas[18][4],zaryaCnt),
        ...
        PlayerDetail reinhardtDetail = new PlayerDetail((long)min, season, 19, "reinhardt", "라인하르트",
                ...
                calculateData(datas[19][12],reinhardtCnt), calculateData(datas[19][2],reinhardtCnt), calculateData(datas[19][3],reinhardtCnt), calculateData(datas[19][4],reinhardtCnt),
        ...
        PlayerDetail dvaDetail = new PlayerDetail((long)min, season, 20, "D.Va", "디바",
                ...
                calculateData(datas[20][12],dvaCnt), calculateData(datas[20][2],dvaCnt), calculateData(datas[20][3],dvaCnt), calculateData(datas[20][4],dvaCnt),
        ...
        PlayerDetail winstonDetail = new PlayerDetail((long)min, season, 21, "winston", "윈스턴",
                ...
                calculateData(datas[21][12],winstonCnt), calculateData(datas[21][2],winstonCnt), calculateData(datas[21][3],winstonCnt), calculateData(datas[21][4],winstonCnt),
        ...
        PlayerDetail roadhogDetail = new PlayerDetail((long)min, season, 22, "roadhog", "로드호그",
               calculateData(datas[22][0], roadhogCnt), "", "", calculateData(datas[22][1], roadhogCnt),
                calculateData(datas[22][12],roadhogCnt), calculateData(datas[22][2],roadhogCnt), calculateData(datas[22][3],roadhogCnt), calculateData(datas[22][4],roadhogCnt),
        ...
        PlayerDetail wreckingballDetail = new PlayerDetail((long)min, season, 23, "wreckingball", "레킹볼",
                ...
                calculateData(datas[23][12],wreckingballCnt), calculateData(datas[23][2],wreckingballCnt), calculateData(datas[23][3],wreckingballCnt), calculateData(datas[23][4],wreckingballCnt),
        ...
        PlayerDetail moiraDetail = new PlayerDetail((long)min, season, 24, "moira", "모이라",
                ...
                calculateData(datas[24][12],moiraCnt), calculateData(datas[24][2],moiraCnt), calculateData(datas[24][3],moiraCnt), calculateData(datas[24][4],moiraCnt),
        ...
        PlayerDetail anaDetail = new PlayerDetail((long)min, season, 25, "ana", "아나",
                ...
                calculateData(datas[25][12],anaCnt), calculateData(datas[25][2],anaCnt), calculateData(datas[25][3],anaCnt), calculateData(datas[25][4],anaCnt),
        ...
        PlayerDetail baptisteDetail = new PlayerDetail((long)min, season, 27, "baptiste", "바티스트",
                ...
                calculateData(datas[27][12],baptisteCnt), calculateData(datas[27][2],baptisteCnt), calculateData(datas[27][3],baptisteCnt), calculateData(datas[27][4],baptisteCnt),
