...
//    private Long deaths;
    ...
    /**영웅별 특수 데이터*/
    @Column(name = "forcusing_beam_kill_avg")
    private String forcusingBeamKillAvg;

    @Column(name = "sticky_bombs_kill_avg")
    private String stickyBombsKillAvg;

    @Column(name = "duplicate_kill_avg")
    private String duplicateKillAvg;
    ...
    public String toString() {
        return "Echo{" +
                ...
                ", forcusingBeamKillAvg='" + forcusingBeamKillAvg + '\'' +
                ", stickyBombsKillAvg='" + stickyBombsKillAvg + '\'' +
                ", duplicateKillAvg='" + duplicateKillAvg + '\'' +
